...
- [x] Add assets for extraction in the app directory
...
- [x] Change package name to "ph.attendo.deped.manila" (disregarded)
- [x] Item 1 in select dialog is selected by default to avoid "null" values
